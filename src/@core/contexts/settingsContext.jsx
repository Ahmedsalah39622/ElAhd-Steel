...
export const SettingsProvider = props => {
  ...
  // State
  // Always ensure settings has all required properties
  const safeSettings = {
    ...updatedInitialSettings,
    ...(typeof settingsCookie === 'object' && settingsCookie !== null ? settingsCookie : {})
  }

  const [_settingsState, _updateSettingsState] = useState(safeSettings)
