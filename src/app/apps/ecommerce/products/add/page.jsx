      ...
      <Grid container spacing={6}>
        ...
        <Grid size={{ xs: 12, md: 8 }}>
          <div className='flex flex-col gap-6'>
            ...
            {/* Product Variants */}
            <ProductVariants formData={formData} handleFormChange={handleFormChange} />
          </div>
        </Grid>
        ...
        <Grid size={{ xs: 12, md: 4 }}>
          <div className='flex flex-col gap-6'>
            {/* Product Organize */}
            <ProductOrganize formData={formData} handleFormChange={handleFormChange} />

            {/* Product Pricing */}
            <ProductPricing formData={formData} handleFormChange={handleFormChange} />

            {/* Product Inventory */}
            <ProductInventory formData={formData} handleFormChange={handleFormChange} />
          </div>
        </Grid>
      </Grid>
    </div>
